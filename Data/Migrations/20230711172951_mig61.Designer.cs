...
namespace outreach3.Data.Migrations
{
    ...
    [Migration("20230711172951_mig61")]
    partial class mig61
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MemberVisitation", b =>
                {
                    b.Property<int>("VisitationsVisitationId")
                        .HasColumnType("int");

                    b.Property<int>("VisitorsMemberId")
                        .HasColumnType("int");

                    b.HasKey("VisitationsVisitationId", "VisitorsMemberId");

                    b.HasIndex("VisitorsMemberId");

                    b.ToTable("MemberVisitation");
                });
            ...
            modelBuilder.Entity("MemberVisitation", b =>
                {
                    b.HasOne("outreach3.Data.Visitation", null)
                        .WithMany()
                        .HasForeignKey("VisitationsVisitationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("outreach3.Data.Member", null)
                        .WithMany()
                        .HasForeignKey("VisitorsMemberId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
